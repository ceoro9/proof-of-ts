...
import { MongooseSessionService } from '@post-serivce/mongoose/session.service';
import { BaseModelService }       from '@post-serivce/base/base.service';
import { IResourceId }            from '@post-serivce/base/data-types/resource-id';
